...
<span class="label label-success">Tip:</span> [The mobile section](/concepts/mobile/#ServerAccountsscreen) details the server accounts management. This way you can configure a connection to your local Flower Platform server.
